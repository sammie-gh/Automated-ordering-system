...
public class TableSix extends AppCompatActivity {


    android.support.v7.widget.GridLayout table_sixGrid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        table_sixGrid = findViewById(R.id.table_6_grid);

        //Toolbar
        mToolbar = (Toolbar) findViewById(R.id.main_app_bar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Table for Six");
        ...
        //set event
        SetSingleEvent(table_sixGrid);
        // setToggleEvent(mainGrid);
    }

    private void SetSingleEvent(android.support.v7.widget.GridLayout table_sixGrid) {


        for (int i = 0; i
                < table_sixGrid.getChildCount();
             i++) {
            //you can see, all child is cardview , so we just cast object to cardView
            CardView cardView = (CardView) table_sixGrid.getChildAt(i);
            final int finalI = i;
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        Intent intent = new Intent(TableSix.this, MainActivity.class);
                    ...
                    else if (finalI == 3) //open 4
                    {
                        ...
                        Toast.makeText(TableSix.this, "Please set activity for this card ", Toast.LENGTH_LONG).show();
                    }
